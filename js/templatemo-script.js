...
$(document).ready(function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
        ...
        var downloadBtn = document.querySelector('.tm-btn-next');

        // Add a click event listener to the button
        downloadBtn.addEventListener('click', function () {
            // Replace 'path/to/your/cv.pdf' with the actual path to your CV file
            var cvFilePath = './CV_2023-12-06_Wissal_Afoulki.pdf';

            // Create a temporary link element
            var downloadLink = document.createElement('a');

            // Set the download link's href to the CV file path
            downloadLink.href = cvFilePath;

            // Set the download attribute to prompt the user to download the file
            downloadLink.download = 'CV_2023-12-06_Wissal_Afoulki.pdf';
